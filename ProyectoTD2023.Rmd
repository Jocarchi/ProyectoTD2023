...
cab_info <- file.info("../data/data/1059xlxveei79_ECGf2/27_09_2022/14.42.29_III_ECGyEXTyRESTO/cabecera_FicheroDigital.dat")

max_cabdig1 <- cab_info$size
...
cabecera_ana1 <- readBin(cab_dig1,integer(),n = max_cabana1,size = 1, signed = F)
